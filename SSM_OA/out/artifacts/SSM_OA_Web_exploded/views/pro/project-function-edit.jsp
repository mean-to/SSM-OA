...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/css/base.css">
	...
	<script type="text/javascript">
		$(function () {
			var proname='${fun.proname}';//当前编辑的功能对应的项目名
			//alert(proname);
			$.ajax({
		...
		function addayalisys(pnameAndAna) {
			...
			//异步请求改需求下所有模块
			var mid='${fun.modeleFk}';//获取当前要编辑的功能对应的模块
			$("#mod option").remove();
			$.ajax({
...
<form name="form2" id="forms" action="${pageContext.request.contextPath}/fun/editFun" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input value="${fun.functionname}" name="functionname"/></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">优先级：</td>
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select name="level">
			<option <c:if test="${fun.level eq '高'}">selected</c:if> >高</option>
			<option <c:if test="${fun.level eq '中'}">selected</c:if> >中</option>
			<option <c:if test="${fun.level eq '低'}">selected</c:if> >低</option>
			<option <c:if test="${fun.level eq '暂缓'}">selected</c:if> >暂缓</option>
		</select>
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea rows=10 cols=130 name="simpledis">${fun.simpledis}</textarea></td>
</tr>
<tr >
	<td align="right" bgcolor="#FAFAF1" height="22">详细描述：</td>
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea rows=15 cols=130 name="detaileddis">${fun.detaileddis}</textarea></td>
</tr>

<tr >
	<td align="right" bgcolor="#FAFAF1" >备注：</td>
	<td colspan=3 align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" >
		<textarea rows=10 cols=130 name="remark">${fun.remark}</textarea>
	</td>
</tr>

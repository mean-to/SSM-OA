...
<form name="form2" method="post" action="${pageContext.request.contextPath}/file/updateFile" enctype="multipart/form-data" id="form2">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		${att.path}<input type="file" name="files"/>&nbsp;&nbsp;&nbsp;<a>添加</a>&nbsp;&nbsp;&nbsp;<a>删除</a>
			<input type="hidden" value="${att.path}" name="path">
</tr >

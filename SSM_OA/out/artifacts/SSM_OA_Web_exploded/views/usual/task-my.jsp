...
<!--  搜索表单  -->
<form name='form3' action='${pageContext.request.contextPath}/task/taskmy' method="post" id="prose">
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td align="center">
        ...
        <c:if test="${task.status==2}">已完成</c:if></td>
	<td align="center">${task.level}</td>
	<td><fmt:formatDate value='${task.starttime}' pattern="yyyy-MM-dd"></fmt:formatDate></td>
	<td>${task.endtime}</td>
	<td><a href="${pageContext.request.contextPath}/task/startTask?id=${task.id}&st=1">开始任务</a>
        | <a href="${pageContext.request.contextPath}/task/startTask?id=${task.id}&st=2">任务完成</a> | <a href="task-look.html">查看详情</a></td>
</tr>
</c:forEach>
    <tr>
        <td colspan="9">

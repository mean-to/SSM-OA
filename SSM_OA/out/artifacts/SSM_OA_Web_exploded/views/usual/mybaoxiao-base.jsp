...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/views/usual/mybaoxiao-add.jsp';" value='添加报销' />
 </td>
 </tr>
</table>
</td>
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<c:forEach items="${blist}" var="bs" varStatus="cou">
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	<td><input name="id" type="checkbox" id="id" value="${bx.bxid}" class="np"></td>
	<td>${cou.count}</td>
	<td>${bs.totalmoney}</td>
	<td align="center"><a href=''><u>
		<fmt:formatDate value="${bs.bxtime}" pattern="yyyy-MM-dd"></fmt:formatDate> </u></a></td>
	<td>${bs.bxremark}</td>

	<c:if test="${bs.bxstatus == 0}">
		<td>未审批</td>
		<td><a href="${pageContext.request.contextPath}/bx/getBxId?id=${bs.bxid}&fl=0">编辑</a> </td>
	</c:if>

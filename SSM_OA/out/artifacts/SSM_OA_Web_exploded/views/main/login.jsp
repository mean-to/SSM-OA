					...
					<TD background=images/crm_12.gif colSpan=6>
						<TABLE id=table1 cellSpacing=0 cellPadding=0 width="98%" border=0>
							<TBODY>
								<TR>
									<TD>
										<form action="${pageContext.request.contextPath}/task/login" method="post" id="form8">
										<TABLE id=table2 cellSpacing=1 cellPadding=0 width="100%"
											...
											<TBODY>
												<TR>
													...
													<TD>
														<INPUT class=regtxt title=请填写用户名 maxLength=16
												...
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16  id=pass name="password"></TD>
												</TR>
												<TR>
													<TD colspan="2">${msg}</TD>
												</TR>

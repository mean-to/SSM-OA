            ...
            <td background='skin/images/wbg.gif' align='center'>
                <table border='0' cellpadding='0' cellspacing='0'>
                    <tr>
                        ...
                        <td width='160'>
                            <input type='text' id="info" value="${qo.key}" name='key' style='width:120px' />
                        </td>
                        <td width='110'>
                            <select id="mtime" name='order' style='width:120px'>
                                <option value='0'>排序...</option>
                                <option value='1' <c:if test="${qo.order==1}">selected</c:if>>编号</option>
                            </select>
                        </td>
                        <td>

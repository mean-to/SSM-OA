...
<script type="text/javascript">
	$(function () {
		$.ajax({
			url:'${pageContext.request.contextPath}/ana/getProNoAna',
			type:'post',
			dataType:'json',
			success:function (data) {
				$.each(data,function (index,pro) {
					$("#pro").append("<option value='"+pro.pname +"'>"+pro.pname+"</option>");
...
/*	$(function () {
		$.ajax({
			url:'${pageContext.request.contextPath}/pro/getProsNoHasNeed',
            type:'post',
			dataType:'json',
			success:function(data){
              $.each(data,function (index,pro) {
              	console.log(data);
				 $("#pro").append("<option value='"+pro.pid+"'>"+pro.pname+"</option>");
			  })
			}
		});
	})
...
<form name="form2" action="${pageContext.request.contextPath}/ana/saveAna" id="form3">

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="2" background="skin/images/tbg.gif">&nbsp 添加新需求&nbsp;</td>
</tr>
<tr >

...
<form name="form2" id="forms" action="${pageContext.request.contextPath}/pro/saveInfo" method="POST">
	...
	<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
			...
			<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<select id="com" name="newcomname"  onchange="addcus(this.value)">
					...
					<c:forEach items="${clist}" var="cus">
						<option value="${cus.id}_${cus.companyperson}">${cus.comname}</option>
					</c:forEach>
				</select>
			</td>
		</tr>
		...
		<tr >
			...
			<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<input type="text" name="buildtime" id="lxt"/></td>
		...
		<tr >
			...
			<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
				<input type="text" name="endtime" id="et"/></td>
		</tr>
		...
		<tr bgcolor="#FAFAF1">
			<td height="28" colspan=4 align=center>
				...
				<a href="views/pro/project-base.jsp" class="coolbg">返回</a>
			</td>
		</tr>
	</table>

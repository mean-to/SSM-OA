...
<script type="">
	$(function () {
		$.ajax({
			url:'${pageContext.request.contextPath}/file/getAllFile',
			type:'post',
			dataType:'json',
			success:function (data) {
				$.each(data,function (index,pro) {

			$("#pron").append("<option value='"+ pro.pid+"'>"+pro.pname+"</option>");
...
<form name="form2" id="form6" action="${pageContext.request.contextPath}/file/saveInfo" method="post" enctype="multipart/form-data">

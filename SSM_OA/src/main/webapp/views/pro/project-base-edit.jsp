...
<form name="form2" id="form2" action="${pageContext.request.contextPath}/pro/updatePro" method="post">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#fdf4fa';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input type="text"  id="cp" name="comper" value="${pro.comper}"/>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
        <input value="<fmt:formatDate value='${pro.endtime}' pattern='yyyy-MM-dd'></fmt:formatDate>" id="lxt" name="endtime"/></td>
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
	<select name="level">
		<option <c:if test="${pro.level==1}" ></c:if> value="1">紧急</option>

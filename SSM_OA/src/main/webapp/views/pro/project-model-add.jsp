...
function addayalisys(isAndnamet) {
	$("#anid option").remove();
var title = isAndnamet.split("_")[2];

	$("#anid").append("<option value='"+isAndnamet.split("_")[0]+"'>"+title +"</option>");
}
</script>
...
<form name="form2" id="form4" action="${pageContext.request.contextPath}/mou/saveInfo" method="post">

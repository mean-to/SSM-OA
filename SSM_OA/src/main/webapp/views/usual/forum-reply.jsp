...
<form name="form2" action="${pageContext.request.contextPath}/fom/evadd" id="form15" method="post">
...
<tr >
		...
		<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
			<input type="hidden" value="${fom.forumid}" name="forumFk">
			<input type="hidden" value="" name="evaidFk" id="fk">
               <span>发布人：${fom.emp.ename}</span><br>
				<span>发布时间：${fom.createtime}</span><br>
				<span>标题：${fom.forumtitle}</span>
				<span>内容：${fom.forumcontent}</span>
		</td>
</tr>

<c:forEach items="${fom.evlist}" var="evp">
		<tr>
			<td align="right" bgcolor="#FAFAF1" height="22">
					<span>
						<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
			...
			<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
				...
				<span>评论人：${evp.emp.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<span>评论时间：${evp.evatime}</span><br>
				<span>评论内容：${evp.evacontent}</span>
				&nbsp;<span><a href="javascript:reply('${evp.evaid}')">【回复】</a></span>
			</td>
		</tr>
<c:forEach items="${evp.evList}" var="evp2">
				<tr>
					<td align="right" bgcolor="#FAFAF1" height="22">
					<span>
						<img src='${pageContext.request.contextPath}/images/tx.png' height='50px' width='50px'/>
					...
					<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';"
						onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
						<span>${evp.emp.ename}回复了${evp2.emp.ename}</span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<span>回复时间：${evp2.evatime}</span><br>
						<span>回复内容：${evp2.evacontent}</span>
					</td>
				</tr>
